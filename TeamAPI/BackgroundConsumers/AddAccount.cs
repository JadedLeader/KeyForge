...
namespace TeamAPI.BackgroundConsumers
{
    public class AddAccount : GenericGrpcConsumer<StreamAccountResponse, AccountDataModel>
    {

        private readonly Account.AccountClient _accountClient;

        public AddAccount(Account.AccountClient accountClient, IServiceScopeFactory serviceScopeFactory): base(serviceScopeFactory)
        {
